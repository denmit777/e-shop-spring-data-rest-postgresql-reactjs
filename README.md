1.Name of project: e-shop-spring-data-rest-postgresql-reactjs

2.Launch of project: 
backend part: mvn run clean tomcat7:run
node modules: e-shop-spring-data-rest-postgresql-reactjs\src\frontend-react\java-learn-app-main>npm install
frontend part: e-shop-spring-data-rest-postgresql-reactjs\src\frontend-react\java-learn-app-main>npm start
